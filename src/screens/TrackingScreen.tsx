        ...
        <View style={styles.card}>
          ...
          {trackList.length === 0 ? (
            ...
            trackList.map((track, index) => {
              ...
              const showSignatureIcon = getImageUri(track.esig_cus) && isDeliverySuccess;
              ...
              return (
                ...
                >
                  ...
                  <Text style={[
                    styles.cell, { flex: 2 },
                    !!(track.picture || showSignatureIcon) && styles.cellHighlight,
                  ]}>
                    {track.status_name}
          ...
          >
            <SafeAreaView style={styles.modalInner}>
              ...
              >
                ...
                {!!getImageUri(selectedTrack?.picture) && (
                  <View style={styles.imageSection}>
                    ...
                    <Image
                      ...
                      resizeMode="contain"
                      onError={e => console.log('picture error:', e.nativeEvent.error)}
                    />
                  </View>
                )}

                {/* ✅ ลายเซ็นผู้รับสินค้า (แสดงเฉพาะสถานะ 'การจัดส่งสำเร็จ') */}
                {!!getImageUri(selectedTrack?.esig_cus) && selectedTrack?.status_name === 'การจัดส่งสำเร็จ' && (
                  <View style={styles.imageSection}>
                    <Text style={styles.detailLabel}>ลายเซ็นผู้รับสินค้า :</Text>
                    <Image
                ...
                {!!getImageUri(selectedTrack?.esig_req) && selectedTrack?.status_name === 'การจัดส่งสำเร็จ' && (
                  <View style={styles.imageSection}>
